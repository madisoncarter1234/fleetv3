...
def show_product_page():
    ...
    # Upload sections with your exact styling
    ...
    if st.button("🔍 Run Fraud Analysis", type="primary", use_container_width=True):
        if fuel_file:
            ...
            # Sample results using your demo data
            ...
            # Sample violation details using your format
            ...
            with st.expander("**After Hours Usage** - Driver: Sarah Wilson (VAN-003)"):
                st.write("**Vehicle:** VAN-003")
                st.write("**Time:** 2024-01-14 02:30:00")  
                st.write("**Location:** BP Station - Interstate 285")
                st.write("**Description:** Fuel purchase at 2:30 AM outside business hours")
                st.write("**Severity:** HIGH")
                st.write("**Estimated Loss:** $125.00")
                
            with st.expander("**Rapid Purchases** - Driver: Mike Chen (TRUCK-007)"):
                st.write("**Vehicle:** TRUCK-007")
                st.write("**Time:** 2024-01-13 16:45:00")
                st.write("**Location:** Shell Station - Highway 75")
                st.write("**Description:** Two purchases within 2 hours at different locations")
                st.write("**Severity:** MEDIUM")
                st.write("**Estimated Loss:** $75.00")
        else:
